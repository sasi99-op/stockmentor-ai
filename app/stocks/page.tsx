...
export default function StocksPage() {
  return (
    <div className="mx-auto max-w-4xl px-4 py-16 text-center space-y-6">
      ...
      <h1 className="text-3xl font-bold text-white">Stock Research & Fundamentals</h1>
      <p className="text-slate-400 max-w-lg mx-auto text-sm leading-relaxed">
        Symbol search across 2000+ NSE/BSE listed equities, balance sheet breakdowns, and operating cash flow metrics
        will be delivered in Phase 2.
      </p>
